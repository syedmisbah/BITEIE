...
import android.widget.ProgressBar;
        ...
        public class MarksActivity extends AppCompatActivity {
            ...
            protected void onCreate(Bundle savedInstanceState) {
                ...
                {
                    webView.loadData((getString(R.string.url_mks_3)),"text/html", "UTF-8");
                }

                else if (semTitle.equalsIgnoreCase(SemSelAttn.semester_4))
                {
                    webView.loadData((getString(R.string.url_mks_4)),"text/html", "UTF-8");
                }

                else if (semTitle.equalsIgnoreCase(SemSelAttn.semester_5))
                {
                    webView.loadData((getString(R.string.url_mks_5)),"text/html", "UTF-8");
                }

                else if (semTitle.equalsIgnoreCase(SemSelAttn.semester_6))
                {
                    webView.loadData((getString(R.string.url_mks_6)),"text/html", "UTF-8");
                }

                else if (semTitle.equalsIgnoreCase(SemSelAttn.semester_7))
                {
                    webView.loadData((getString(R.string.url_mks_7)),"text/html", "UTF-8");
                }

                else
                {
                    webView.loadData((getString(R.string.url_mks_8)),"text/html", "UTF-8");
                }
